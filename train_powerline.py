...
from data.powerline_npy_dataset import PowerlineNpyDataset, POWERLINE_CLASSES

ROOT_DIR = os.path.dirname(os.path.abspath(__file__))
sys.path.append(os.path.join(ROOT_DIR, 'models'))

seg_classes = POWERLINE_CLASSES
...
def parse_args():
    parser = argparse.ArgumentParser('Training with Powerline NPY Dataset')
    ...
    parser.add_argument('--npy_dir', type=str, default='/home/link/data/point_seg/npy_v2', help='Path to NPY dataset root')
    ...
    parser.add_argument('--use_intensity', action='store_true', default=True, help='Use intensity feature')
...
def main(args):
    ...
    log_dir = log_dir.joinpath('powerline_seg')
    log_dir.mkdir(exist_ok=True)
    ...
    print(f"Training with {NUM_CLASSES} classes: {POWERLINE_CLASSES}")
    print(f"Data directory: {args.npy_dir}")

    train_dataset = PowerlineNpyDataset(
    ...
    val_dataset = PowerlineNpyDataset(
        npy_dir=args.npy_dir,
        split='val',
        num_points=args.npoints,
        block_size=args.block_size,
